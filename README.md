...
## 🍎 3. Running on macOS (Apple Silicon Only)

**⚠️ Important:** This build is for **Apple Silicon (M1 and up)** Macs only. It will not work on older Intel-based Macs.
...
2. Click "Allow" to run the application.
...
This project was created in collaboration with **Gemini 3 Pro**.
